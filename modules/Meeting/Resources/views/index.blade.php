...
<div class="row">
    ...
    <div class="col-sm-5">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                components for navigation, pagination, labels, alerts etc..
            </div>
        </div>
    ...
    <div class="col-sm-7">
        ...
        <div class="well">
            <form class="form">
                ...
                <div class="input-group text-center">
                    ...
                    <span class="input-group-btn"><button class="btn btn-lg btn-primary" type="button">OK
                        </button></span>
                </div>
            </form>
        </div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading"><a href="#" class="pull-right">View all</a> <h4>Bootply Editor &amp; Code
                    Library</h4></div>
            <div class="panel-body">
                ...
                <div class="clearfix"></div>
                <hr>
                Design, build, test, and prototype using Bootstrap in real-time from your Web browser. Bootply combines
                the power of hand-coded HTML, CSS and JavaScript with the benefits of responsive design using Bootstrap.
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <p>If you're looking for help with Bootstrap code, the <code>twitter-bootstrap</code> tag at <a
                            href="http://stackoverflow.com/questions/tagged/twitter-bootstrap">Stackoverflow</a> is a
                    good place to find answers.</p>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <p>
                    <img src="https://lh6.googleusercontent.com/-5cTTMHjjnzs/AAAAAAAAAAI/AAAAAAAAAFk/vgza68M4p2s/s28-c-k-no/photo.jpg"
                         width="28px" height="28px">
                    <img src="https://lh4.googleusercontent.com/-6aFMDiaLg5M/AAAAAAAAAAI/AAAAAAAABdM/XjnG8z60Ug0/s28-c-k-no/photo.jpg"
                         width="28px" height="28px">
