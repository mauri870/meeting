...
class MeetingServiceProvider extends ServiceProvider {
	...
	protected function registerConfig()
	{
		...
		$this->mergeConfigFrom(
		    __DIR__.'/../Config/config.php', 'meeting'
		);
	}
	...
	{
		$viewPath = base_path('resources/views/modules/meeting');
		...
		$this->loadViewsFrom([$viewPath, $sourcePath], 'meeting');
	}
	...
	{
		$langPath = base_path('resources/lang/modules/meeting');
