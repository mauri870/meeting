...
<div class="container">
    <div class="row text-center">
        <div class="col-sm-12">
            ...
            <h3 class="wow fadeInUp" data-wow-delay="0.6s">A página que você está procurando foi abduzida, não existe ou não
                está mais disponível</h3>

            <div class="wow bounceIn" data-wow-delay="0.7s">
                <img src="{{ asset('images/errors/404.gif') }}" alt="balloon">
            </div>
